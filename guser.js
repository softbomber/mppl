...
setInterval(function(){$.post("pbuy.php",{racc:1},function(r){if(r){var nv=Number(r.s).toFixed(2);if($("#deposit").text()!==nv){$("#deposit").text(nv);if(r.i!=null)$(intrst).val(r.i+"%");}}});},30000);
