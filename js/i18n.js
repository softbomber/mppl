...
(function (global) {
  ...
  var DICT = {
    ru: {
      ...
      'info.balance': 'Баланс',
      'info.discount': 'Ваша скидка:',
      'info.reg_date': 'Дата регистрации',
      'cards.number': 'Номер карты',
      'cards.holder': 'Владелец карты',
      'cards.expires': 'Годен до',
      'cards.list': 'СПИСОК КАРТ',
      'edit.password': 'Пароль:',
      'edit.email': 'E-mail:',
      'edit.tid': 'TID:',
      'edit.mobile': 'Мобильный #:',
      'edit.server': 'Сервер:',
      'edit.comment': 'Комент',
      'edit.notify_phone': 'Отправлять оповещения на номер',
      'validate.bad_chars': 'Символы `!@#$%^&*()+=-[]\\\';,./{}|\\\":<>? пробел и кириллица не допустимы',
      'validate.min_chars': 'Минимум 4 символа',
      'validate.enter_login': 'Введите логин',
      'validate.enter_password': 'Введите пароль',
      'validate.login_taken': 'Логин занят',
      'validate.enter_sum': 'Введите сумму',
      'validate.valid_email': 'Введите правильный email',
      'msg.account_registered': 'АККАУНТ ЗАРЕГИСТРИРОВАН',
      'msg.config_sent': 'ФАЙЛ КОНФИГУРАЦИИ УСПЕШНО ОТПРАВЛЕН',
      'msg.email_error': 'ПРИ ОТПРАВКЕ E-MAIL ПРОИЗОШЛА ОШИБКА!',
      'msg.session_expired': 'Сессия истекла. Необходима повторная авторизация.',
      'btn.extend_subscription': 'ПРОДЛИТЬ ПОДПИСКУ НА ',
      'lang.label': 'Язык / Language',
      'lang.ru': 'RU',
      'lang.en': 'EN',

      'net.offline_header': 'Соединение',
      ...
      'auth.session_expired_title': 'ПОВТОРНЫЙ ВХОД',
      'auth.session_expired_msg': 'Сессия истекла — войдите заново',
    ...
    en: {
      ...
      'info.discount': 'Your discount:',
      'info.reg_date': 'Registration date',
      ...
      'edit.notify_phone': 'Send notifications to phone',
      'validate.bad_chars': 'Characters `!@#$%^&*()+=-[]\\\';,./{}|\\\":<>? spaces and Cyrillic are not allowed',
      'validate.min_chars': 'Minimum 4 characters',
      'validate.enter_login': 'Enter login',
      'validate.enter_password': 'Enter password',
      'validate.login_taken': 'Login is taken',
      'validate.enter_sum': 'Enter the amount',
      'validate.valid_email': 'Enter a valid email',
      'msg.account_registered': 'ACCOUNT REGISTERED',
      'msg.config_sent': 'CONFIGURATION FILE SENT SUCCESSFULLY',
      'msg.email_error': 'AN ERROR OCCURRED WHILE SENDING EMAIL!',
      'msg.session_expired': 'Session expired. Re-authorization required.',
      'btn.extend_subscription': 'EXTEND SUBSCRIPTION FOR ',
      'lang.label': 'Language / Язык',
      'lang.ru': 'RU',
      'lang.en': 'EN',

      'net.offline_header': 'Connection',
      ...
      'auth.session_expired_title': 'SIGN IN AGAIN',
      'auth.session_expired_msg': 'Session expired — please log in again',
